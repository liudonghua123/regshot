...
IF "%SOURCE%" == "VS2008" (
  SET SOURCEFILEx86WA=%VS_OUTPUT%bin\%SOURCE%\%VS_PROJECT_NAME%\Win32\Release\%VS_SOURCEFILE_BASENAME%-x86-ANSI.exe
  SET SOURCEFILEx86WU=%VS_OUTPUT%bin\%SOURCE%\%VS_PROJECT_NAME%\Win32\Release Unicode\%VS_SOURCEFILE_BASENAME%-x86-Unicode.exe
  SET SOURCEFILEx64WA=%VS_OUTPUT%bin\%SOURCE%\%VS_PROJECT_NAME%\x64\Release\%VS_SOURCEFILE_BASENAME%-x64-ANSI.exe
  SET SOURCEFILEx64WU=%VS_OUTPUT%bin\%SOURCE%\%VS_PROJECT_NAME%\x64\Release Unicode\%VS_SOURCEFILE_BASENAME%-x64-Unicode.exe
  SET SUFFIX=_VS2008
  SET SYMBOLS_SUFFIX=pdb
)
IF "%SOURCE%" == "VS2010" (
