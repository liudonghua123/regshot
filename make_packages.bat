...
IF "%SOURCE%" == "VS2008" (
  SET SOURCEFILEx86A=%VS_OUTPUT%bin\%SOURCE%\Regshot\Win32\Release\Regshot-x86-ANSI.exe
  SET SOURCEFILEx86U=%VS_OUTPUT%bin\%SOURCE%\Regshot\Win32\Release Unicode\Regshot-x86-Unicode.exe
  SET SOURCEFILEx64A=%VS_OUTPUT%bin\%SOURCE%\Regshot\x64\Release\Regshot-x64-ANSI.exe
  SET SOURCEFILEx64U=%VS_OUTPUT%bin\%SOURCE%\Regshot\x64\Release Unicode\Regshot-x64-Unicode.exe
  SET SUFFIX=_VS2008
...
@rem *** binary package
SET PACKAGE_FILENAME_BASE=Regshot-%REGSHOTVER%
...
@rem *** symbols package
SET PACKAGE_FILENAME_BASE=Regshot-%REGSHOTVER%-symbols
