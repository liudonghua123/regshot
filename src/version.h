...
#define REGSHOT_VERSION_STRING   STRINGIFY(REGSHOT_VERSION_MAJOR) "." STRINGIFY(REGSHOT_VERSION_MINOR) "." STRINGIFY(REGSHOT_VERSION_PATCH) "-trunk"
#ifdef _WIN64
#define REGSHOT_FILE_DESCRIPTION  "Regshot x64"
#define REGSHOT_TITLE  "Regshot x64"
#define REGSHOT_RESULT_FILE  "~res-x64"
#else
#define REGSHOT_FILE_DESCRIPTION  "Regshot"
