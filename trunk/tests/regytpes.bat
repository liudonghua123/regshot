...
reg add HKCU\RegTypes /v REG_DWORD_EMPTY /t REG_DWORD /f
reg add HKCU\RegTypes /v REG_DWORD_LITTLE_ENDIAN_EMPTY /t REG_DWORD_LITTLE_ENDIAN /f
reg add HKCU\RegTypes /v REG_DWORD_BIG_ENDIAN_EMPTY /t REG_DWORD_BIG_ENDIAN /f
...
reg add HKCU\RegTypes /v REG_DWORD_BIG_ENDIAN /t REG_DWORD_BIG_ENDIAN /f /d 0x12345678
